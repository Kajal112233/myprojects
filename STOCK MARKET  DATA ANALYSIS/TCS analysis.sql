...
--Insights :
--TCS had an average spread of 24 Rs.
...
--TCS had an average monthly trade of 3029647 shares
...
WHERE "Date" BETWEEN '2015-01-01' AND '2018-07-31';
--Insights:
-- TCS have 46.82 average delivery ratio.
...
--TCS had highest trading day at 44817 trades