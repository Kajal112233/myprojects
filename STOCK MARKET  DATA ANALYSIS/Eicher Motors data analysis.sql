...
FROM public."Eicher Motors"
WHERE "Date" BETWEEN '01-01-2015' AND '31-07-2018';
--insight:
--Eicher Motors saw 82.56 per growth.
...
--Insights :
--Eicher Motors had an average spread of 404 Rs.
...
--Eicher Motors had an average monthly trade of 83634 shares
...
-- Eicher Motors have 33.38 average delivery ratio.
...
-- Eicher Motors had highest trading day at 36557 trades